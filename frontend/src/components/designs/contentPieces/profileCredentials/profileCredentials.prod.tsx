...
const ProfileCredentials: React.FC<ProfileCredentialsProps> = (props) => {
  const {
    title = defaultProfileCredentialsProps.title,
    subTitle = defaultProfileCredentialsProps.subTitle,
    description = defaultProfileCredentialsProps.description,
    images = defaultProfileCredentialsProps.images,
    textArray = defaultProfileCredentialsProps.textArray,
    button,
    buttonText,
    textColor = defaultProfileCredentialsProps.textColor,
    baseBgColor = defaultProfileCredentialsProps.baseBgColor,
    mainColor = defaultProfileCredentialsProps.mainColor,
    bgLayout = defaultProfileCredentialsProps.bgLayout,
  } = props;
  ...
  const profileImg = images?.profile || defaultProfileCredentialsProps.images.profile!;
