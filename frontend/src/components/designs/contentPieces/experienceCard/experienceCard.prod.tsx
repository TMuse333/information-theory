...
import { ExperienceCardProps, defaultExperienceCardProps } from "./index";

const ExperienceCard: React.FC<ExperienceCardProps> = (props) => {
  const {
    title = defaultExperienceCardProps.title,
    subTitle = defaultExperienceCardProps.subTitle,
    description = defaultExperienceCardProps.description,
    buttonText = defaultExperienceCardProps.buttonText,
    images = defaultExperienceCardProps.images,
    array = defaultExperienceCardProps.array,
    baseBgColor = defaultExperienceCardProps.baseBgColor,
    mainColor = defaultExperienceCardProps.mainColor,
    textColor = defaultExperienceCardProps.textColor,
    bgLayout = defaultExperienceCardProps.bgLayout,
  } = props;
