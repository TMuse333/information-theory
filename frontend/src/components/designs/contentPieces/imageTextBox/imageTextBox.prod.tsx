...
import { ImageTextBoxProps, defaultImageTextBoxProps } from "./index";

const ImageTextBox: React.FC<ImageTextBoxProps> = (props) => {
  const {
    images = defaultImageTextBoxProps.images,
    title = defaultImageTextBoxProps.title,
    description = defaultImageTextBoxProps.description,
    reverse = defaultImageTextBoxProps.reverse,
    baseBgColor = defaultImageTextBoxProps.baseBgColor,
    textColor = defaultImageTextBoxProps.textColor,
    mainColor = defaultImageTextBoxProps.mainColor,
    bgLayout = defaultImageTextBoxProps.bgLayout,
    objectContain = defaultImageTextBoxProps.objectContain,
    buttonText = defaultImageTextBoxProps.buttonText,
  } = props;
  ...
  const mainImage = images?.main || defaultImageTextBoxProps.images.main;
