...
const CarouselHeroEdit: React.FC<EditorialComponentProps> = ({ id }) => {
  ...
  useEffect(() => {
    console.log("🔍 [CarouselHeroEdit] Sync effect running");
    console.log("🔍 [CarouselHeroEdit] currentComponent?.name:", currentComponent?.name);
    console.log("🔍 [CarouselHeroEdit] safeItems:", safeItems);
    console.log("🔍 [CarouselHeroEdit] id:", id);

    if (currentComponent?.name === "CarouselHero") {
      console.log("✅ [CarouselHeroEdit] Syncing carousel to store");
      setCarousel(id, safeItems);
    } else {
      console.log("❌ [CarouselHeroEdit] Not syncing - currentComponent name doesn't match");
    }
...
const LeftTextSection = ({ componentProps, updateProp, id, colors, buttonConfig }: LeftTextSectionProps) => {
  return (
