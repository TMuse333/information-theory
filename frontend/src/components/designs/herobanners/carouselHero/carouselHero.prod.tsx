...
import { shouldRenderButton, getButtonRenderAction, handleScrollToElement } from "@/lib/utils/buttonHelpers";
import { ButtonConfig } from "@/types/button";
import { CarouselHeroProps, defaultCarouselHeroProps } from "./index";

const CarouselHero: React.FC<CarouselHeroProps> = (props) => {
  const {
    title = defaultCarouselHeroProps.title,
    subTitle = defaultCarouselHeroProps.subTitle,
    description = defaultCarouselHeroProps.description,
    button,
    buttonText,
    items = defaultCarouselHeroProps.items,
    textColor = defaultCarouselHeroProps.textColor,
    baseBgColor = defaultCarouselHeroProps.baseBgColor,
    mainColor = defaultCarouselHeroProps.mainColor,
    bgLayout = defaultCarouselHeroProps.bgLayout,
  } = props;
