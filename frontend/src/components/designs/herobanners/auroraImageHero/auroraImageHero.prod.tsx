...
import { AuroraImageHeroProps, defaultAuroraImageHeroProps } from "./index";

const AuroraImageHero: React.FC<AuroraImageHeroProps> = (props) => {
  const {
    textColor = defaultAuroraImageHeroProps.textColor,
    baseBgColor = defaultAuroraImageHeroProps.baseBgColor,
    mainColor = defaultAuroraImageHeroProps.mainColor,
    bgLayout = defaultAuroraImageHeroProps.bgLayout,
    images = defaultAuroraImageHeroProps.images,
    subTitle = defaultAuroraImageHeroProps.subTitle,
    title = defaultAuroraImageHeroProps.title,
    description = defaultAuroraImageHeroProps.description,
    buttonText = defaultAuroraImageHeroProps.buttonText,
  } = props;
  ...
  const mainImage = images?.main || defaultAuroraImageHeroProps.images.main!;
