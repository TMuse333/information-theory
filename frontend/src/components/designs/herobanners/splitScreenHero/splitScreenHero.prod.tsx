...
const SplitScreenHero: React.FC<SplitScreenHeroProps> = (props) => {
  const {
    title = defaultSplitScreenHeroProps.title,
    subTitle = defaultSplitScreenHeroProps.subTitle,
    description = defaultSplitScreenHeroProps.description,
    buttonText = defaultSplitScreenHeroProps.buttonText,
    images = defaultSplitScreenHeroProps.images,
    textArray = defaultSplitScreenHeroProps.textArray,
    textColor = defaultSplitScreenHeroProps.textColor,
    baseBgColor = defaultSplitScreenHeroProps.baseBgColor,
    mainColor = defaultSplitScreenHeroProps.mainColor,
    bgLayout = defaultSplitScreenHeroProps.bgLayout,
  } = props;
  ...
  const agentImg = images?.agent || defaultSplitScreenHeroProps.images.agent!;
  const propertyImg = images?.property || defaultSplitScreenHeroProps.images.property!;
